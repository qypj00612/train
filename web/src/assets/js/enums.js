...
SEAT_TYPE={FIRST_CLASS:{code:"1",desc:"一等座",price:"0.4"},SECOND_CLASS:{code:"2",desc:"二等座",price:"0.3"},SOFT_SLEEPER:{code:"3",desc:"软卧",price:"0.6"},HARD_SLEEPER:{code:"4",desc:"硬卧",price:"0.5"}};
SEAT_COL={FIRST_CLASS_A:{code:"A",desc:"A",type:"1"},FIRST_CLASS_C:{code:"C",desc:"C",type:"1"},FIRST_CLASS_D:{code:"D",desc:"D",type:"1"},FIRST_CLASS_F:{code:"F",desc:"F",type:"1"},SECOND_CLASS_A:{code:"A",desc:"A",type:"2"},SECOND_CLASS_B:{code:"B",desc:"B",type:"2"},SECOND_CLASS_C:{code:"C",desc:"C",type:"2"},SECOND_CLASS_D:{code:"D",desc:"D",type:"2"},SECOND_CLASS_F:{code:"F",desc:"F",type:"2"}};
